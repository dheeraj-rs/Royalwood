...
function HomeLgOutdoreCard() {
  ...
  return (
    <div className="h-[35vh] lg:flex hidden px-2 shadow-xl  mt-10">
      ...
      {/* header  */}
      <div className="w-[20vw] bg-gradient-to-r from-[#bcbcbc]  to-[#0000006d]  flex flex-col items-center text-4xl bg-blue-gray-400 py-16  ">
        <h1 className='' >Outdoor</h1><span>furnitures</span>
        <div className=""> <button className=" shadow-sm bg-[#3f4ef4] hover:bg-blue-gray-700 focus:shadow-outline focus:outline-none text-white text-xs py-2 px-4 rounded-sm"
         onClick={() => handleType('Outdoor')}>View all</button></div>
      </div>
      {/* image container  */}
      <div className="w-[80vw] bg-gradient-to-r from-[#bcbcbc9a]  to-[#00000050]   flex  gap-5 overflow-y-auto pl-5 py-5  ">
        
        {/* image card */}
          <div className="flex gap-5 rounded-lg  shadow-lg shadow-black " onClick={() => handleType('Swingchair')}>
        ...
        {/* image card */}
          <div className="flex gap-5 rounded-lg  shadow-lg shadow-black "  onClick={() => handleType('Window')}>
            <div className="w-[300px] h-full relative flex gap-5">
        ...
        {/* image card */}
          <div className="flex gap-5 rounded-lg  shadow-lg shadow-black "  onClick={() => handleType('staircase')}>
            <div className="w-[300px] h-full relative flex gap-5">
        ...
        {/* image card */}
          <div className="flex gap-5 rounded-lg  shadow-lg shadow-black "  onClick={() => handleType('Door')}>
            <div className="w-[300px] h-full relative flex gap-5">
