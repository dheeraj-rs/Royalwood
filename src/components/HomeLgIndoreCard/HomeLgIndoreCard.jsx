...
function HomeLgIndoreCard() {
  ...
  return (
    ...
    <div className="h-[35vh] lg:flex hidden px-2 shadow-xl  my-5">

      {/* header  */}
      <div className="w-[20vw] bg-gradient-to-r from-[#0000006d] to-[#bcbcbc]  flex flex-col items-center text-4xl bg-blue-gray-400 py-16  ">
      ...
      {/* image container  */}
      <div className="w-[80vw] bg-gradient-to-r from-[#00000061] to-[#bcbcbcbc] flex  gap-5 overflow-y-auto pl-5 py-5  ">
        
            {/* image card  */}
          <div  className="flex gap-5 rounded-lg shadow-lg shadow-black " 
