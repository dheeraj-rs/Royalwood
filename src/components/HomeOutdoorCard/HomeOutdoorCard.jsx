    ...
    return (
        <div className='h-max flex flex-col pb-5 lg:hidden border border-blue-gray-200 shadow-lg'>
            ...
            <div className="h-[20%] flex justify-between items-center py-5 px-4">
                <h1 className='text-xl font-semibold font-[acorn] '>Outdoor Furniture</h1>
                <button className="block shadow-lg bg-blue-gray-900 hover:bg-blue-gray-700 focus:shadow-outline focus:outline-none text-white text-xs py-2 px-4 rounded">View all</button>
            </div>
            {/* images container  */}
