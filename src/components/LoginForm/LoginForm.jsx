...
const LoginForm = () => {
    ...
    const veryEmail = async () => {
        ...
        toast.success('Your Email veryed')
    }
    ...
    const signIn = async () => {
        try {
            ...
            toast.warning('sorry password errot')
        }
    }
                                ...
                                <form>
                                    ...
                                    <div>
                                        <label className="inline-flex items-center cursor-pointer">
                                            ...
                                            <span className="ml-2 text-sm font-semibold text-blueGray-600 text-blue-800 select-none"
                                                onClick={reset}
                                            >Reset password</span>
                                        </label>
                                    </div>
                                    <div className="">
                                        ...
                                        <div className="">
                                            ...
                                            <button onClick={conformOtp}>conform OTP</button></div>
                                    </div>
                                    <div className="text-center mt-6 flex ">
                                        ...
                                        <button className="bg-gray-600 text-black px-3" onClick={LogOut} >LogOut</button>
                                    </div>
                                </form>
                            </div>
                            <div className="flex justify-center">
                                <p className="text-xl text-center shadow-sm text-blue-500 tracking-wider leading-5 underline rounded-sm px-2 select-none" onClick={handleToggleSign}>Create account</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className={`${toggleSign ? "block" : "hidden"} w-screen h-screen fixed z-[200] backdrop-blur-sm`}>
                <div className="h-full w-full flex justify-center items-center">
                    <div className="container w-[90%] flex flex-col items-center justify-center px-2 rounded-md bg-[#000000bf]">
                        ...
                        <div className="text-gray-600 mt-6 flex gap-5">
                            Already have an account?
                            <p className="underline uppercase text-blue-500" href="../login/" onClick={handleToggleSign}>
                                Log in
                            </p>
                        </div>
                    </div>
